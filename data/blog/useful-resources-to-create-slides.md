...
title: 'Useful resources to create slides'
description: 'A list of tools that you can use to make slides/powerpoints.'
excerpt: 'These are the websites that we found handy when making our materials visually appealing.'
